...
// ResponseData::ResponseData() : totalSize(0), bytesSent(0), status(Pending), flag(0)
// {}
...
HTTPRequest::HTTPRequest() : method(""), uri(""), httpVersion(""), body(""), rawRequest(""), headersComplete(false), flag(0) {}
...
void Server::handleRequestGET(int clientSocket, HTTPRequest& request, informations& serverConfig)
{
    ...
    // responseData.fileStream.open(filePath, std::ios::binary);
